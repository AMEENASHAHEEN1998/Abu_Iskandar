        ...
        <div class="col-xl-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form class=" row mb-30" action="{{ route('admin.products.store') }}" method="POST"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <label for="product_name_ar"
                                        ...
                                        :</label>
                                    <input id="product_name_ar" class="form-control" type="text" name="product_name_ar"
                                        required />
                                </div>
                                ...
                                <div class="col">
                                    <label for="product_name_en"
                                        ...
                                        :</label>
                                    <input id="product_name_en" class="form-control" type="text" name="product_name_en"
                                        required />
                                </div>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="box ">
                                                    <select class="form-control form-control-lg" name="sub_category_id">
                                                        @foreach ($Subcategories as $Category)
                                                            ...
                                                            @else
                                                                <option value="{{ $Category->id }}">
                                                                    {{ $Category->sub_category_name_ar }}</option>
                                                            @endif
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col">
                                                ...
                                                <input class="btn btn-danger btn-block" data-repeater-delete type="button"
                                                    value="{{ trans('admin/products.delete_row') }}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row mt-20">
                                        <div class="col-12">
                                            <input class="button" data-repeater-create type="button"
                                                value="{{ trans('admin/products.add_subcategory') }}" />
                                        </div>
                            ...
                            <div class="repeater">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <label for="product_name_ar"
                                                    ...
                                                    :</label>
                                                <input id="product_name_ar" class="form-control" type="text" name="size"
                                                    required />
                                            </div>
                                ...
                                <div class="row mt-20">
                                    <div class="col-12">
                                        <input class="button" data-repeater-create type="button"
                                            value="{{ trans('admin/products.add_size_price') }}" />
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                        <label for="decription"
                                            ...
                                            :</label>
                                        <textarea class="form-control" type="text" name="decription" cols="30" rows="10">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success">{{ trans('admin/products.submit') }}</button>
