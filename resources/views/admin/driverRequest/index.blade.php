                                    ...
                                    @foreach ($Orders as $Order)
                                        <tr>
                                            ...
                                            @if (App::getLocale() == 'en')
                                                ...
                                                <td>{{ $Order->SubCategory ? $Order->SubCategory->sub_category_name_en : 'Sub Category Deleted' }}
                                                </td>
                                                <td>{{ $Order->Product ? $Order->Product->product_name_en : 'Product Deleted' }}
                                                </td>
                                            @else
                                                <td>{{ $Order->Category ? $Order->Category->category_name_ar : 'غير مصنف' }}
                                                </td>
                                                <td>{{ $Order->SubCategory ? $Order->SubCategory->sub_category_name_ar : 'الفرع غير موجود' }}
                                                </td>
                                                <td>{{ $Order->Product ? $Order->Product->product_name_ar : 'تم حذف المنتج' }}
                                                </td>
                                            @endif
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div>
                                                        <!-- add_form -->
                                                        <form
                                                            action="{{ route('admin.driverrequest.update', $Order->id) }}"
                                                                                ...
                                                                                @foreach ($Categories as $Category)
                                                                                    ...
                                                                                    @else
                                                                                        <option @if ($Order->category_id == $Category->id)
                                                                                            {{ 'selected' }}
                                                                                            @endif
                                                                                            value="{{ $Category->id }}">{{ $Category->category_name_ar }}
                                                                                        </option>
                                                                                    @endif
                                                                                @endforeach
                                                                            </select>
                                                                                ...
                                                                                @foreach ($Subcategories as $Category)
                                                                                    @if (App::getLocale() == 'en')
                                                                                        <option @if ($Order->subcategory_id == $Category->id)
                                                                                            {{ 'selected' }}
                                                                                            @endif
                                                                                            value="{{ $Category->id }}">{{ $Category->sub_category_name_en }}
                                                                                        </option>
                                                                                    @else
                                                                                        <option @if ($Order->subcategory_id == $Category->id)
                                                                                            {{ 'selected' }}
                                                                                            @endif
                                                                                            value="{{ $Category->id }}">{{ $Category->sub_category_name_ar }}
                                                                                        </option>
                                                                                    @endif
                                                                                @endforeach
                                                                            </select>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col">
                                                                        <label for="product"
                                                                            ...
                                                                            :</label>
                                                                        {{ $Order->Product ? $Order->Product->product_name_ar : 'تم حذف المنتج' }}
                                                                    ...
                                                                    <div class="col">
                                                                        ...
                                                                        <input id="number"
                                                                            ...
                                                                            value="{{ $Order->number }}" name="number"
                                                                            required />
                                                                    </div>
