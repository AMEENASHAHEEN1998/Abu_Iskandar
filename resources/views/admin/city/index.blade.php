        ...
        <div class="col-xl-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.city.create') }}" class="btn btn-success" data-toggle="modal"
                        data-target="#exampleModal">
                        {{ trans('admin/city.addcity') }}
                    </a>



                    <br><br>
                    <h1>{{ trans('admin/city.cities') }}</h1>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                ...
                                                title="{{ trans('admin/city.delete') }}"><i
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('admin.city.destroy',$city->id)}}" method="post">
                                                        {{method_field('Delete')}}
                                                        @csrf
                                                        {{ trans('admin/city.warning_city') }}
                                                        <input id="id" type="hidden" name="id" class="form-control"
                                                                value="{{ $city->id }}">
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary"
                                                                    data-dismiss="modal">{{ trans('admin/city.close') }}</button>
                                                            <button type="submit"
                                                                    class="btn btn-danger">{{ trans('admin/city.delete') }}</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    data-dismiss="modal">{{ trans('admin/city.close') }}</button>
                                                <button type="submit"
                                                    class="btn btn-success">{{ trans('admin/city.submit') }}</button>
                                            </div>
