...
class ClassesController extends Controller
{
    ...
    {
        $classess=ClassModel::orderBy('id','desc')->paginate(5);
        return view('admin.classes.index',compact('classess'));
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.classes.index')->with('success',trans('admin/classes.delete_message'));
